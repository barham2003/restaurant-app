...
export class ItemsController {
  ...
  @Post()
  async create(@Body() createItemDto: CreateItemDto): ResponseData<ItemDocument> {
  ...
  @Get(':id')
  async findOne(@Param('id', ParseObjId) id: string): ResponseData<ItemDocument> {
  ...
  @Patch(':id')
  async update(@Param('id', ParseObjId) id: string, @Body() updateItemDto: UpdateItemDto): ResponseData<ItemDocument> {
  ...
  @Delete(':id')
  async remove(@Param('id', ParseObjId) id: string): ResponseData<ItemDocument> {
